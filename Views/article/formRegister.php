    ...
    <div class="row d-flex align-items-center justify-content-center">
        <form class="col-md-6" method="POST">
            <div class="formRegister px-5 py-5">
                ...
                <div class="form-input"> <i class="fa fa-envelope"></i> <input type="email" class="form-control" placeholder="Votre mail" name="mail" required pattern='<?php echo $pattern ?>'> </div>
